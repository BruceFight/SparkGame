...
class JBLogResetView: JBLogView,UITextFieldDelegate {
    ...
    func setResetNode(frame: CGRect) -> () {
        ...
        titleLabel.font = UIFont.systemFont(ofSize: 20, weight: 12)
        ...
        implementLabel.font = UIFont.systemFont(ofSize: 14, weight: 12)
        ...
        getModiCodeBtn.titleLabel?.font = UIFont.systemFont(ofSize: 28, weight: 15)
